...
int FMM3d_MPI::setup()
{
  ...
  /* Build contributor data for a specific processor */
  {
	  ...
	  */
	 pC( VecScatterBegin(_ctbSrcExaPos, _glbSrcExaPos, INSERT_VALUES, SCATTER_FORWARD, _ctb2GlbSrcExaPos) );
	 pC( VecScatterEnd(  _ctbSrcExaPos, _glbSrcExaPos, INSERT_VALUES, SCATTER_FORWARD, _ctb2GlbSrcExaPos) );
	 /* Scatter from _ctbSrcExaNor to _glbSrcExaNor using _ctb2GlbSrcExaPos context */
	 pC( VecScatterBegin(_ctbSrcExaNor, _glbSrcExaNor, INSERT_VALUES, SCATTER_FORWARD, _ctb2GlbSrcExaPos) );
	 pC( VecScatterEnd(  _ctbSrcExaNor, _glbSrcExaNor, INSERT_VALUES, SCATTER_FORWARD, _ctb2GlbSrcExaPos) );
  ...
  /* Build user data for a specific processor */
  {
	  ...
	  * and http://www-unix.mcs.anl.gov/petsc/petsc-as/snapshots/petsc-current/docs/manualpages/Vec/VecScatterEnd.html
	  */
	 pC( VecScatterBegin(_glbSrcExaPos, _usrSrcExaPos, INSERT_VALUES, SCATTER_REVERSE, _usr2GlbSrcExaPos) );
	 pC( VecScatterEnd(  _glbSrcExaPos, _usrSrcExaPos, INSERT_VALUES, SCATTER_REVERSE, _usr2GlbSrcExaPos) );
	 /* Scatter from _usrSrcExaNor to _glbSrcExaNor using _usr2GlbSrcExaPos context */
	 pC( VecScatterBegin(_glbSrcExaNor, _usrSrcExaNor, INSERT_VALUES, SCATTER_REVERSE, _usr2GlbSrcExaPos) );
	 pC( VecScatterEnd(  _glbSrcExaNor, _usrSrcExaNor, INSERT_VALUES, SCATTER_REVERSE, _usr2GlbSrcExaPos) );
