...
public:
  ...
  public:
	 ...
	 int& glbSrcNodeIdx() { return _glbSrcNodeIdx; }
	 /*! Return global source exact beginning index */
	 int& glbSrcExaBeg() { return _glbSrcExaBeg; }
	 ...
	 vector<int>& ctbSrcOwnVecIdxs() { return ptr()->_ctbSrcOwnVecIdxs; }
	 ...
	 vector<int>& evaTrgOwnVecIdxs() { return ptr()->_evaTrgOwnVecIdxs; }
  };
...
protected:
  ...
  /*! global node count for global source vector - number of nodes in global tree */
...
public:
  ...
  int& glbGlbSrcNodeCnt() { return _glbGlbSrcNodeCnt; }
  /*! Return global exact number of sources, available to all processors */
  int& glbGlbSrcExaCnt() { return _glbGlbSrcExaCnt; }
  /*! Return local source node count */
  int& lclGlbSrcNodeCnt() { return _lclGlbSrcNodeCnt; }
  /*! Return local exact number of sources */
  int& lclGlbSrcExaCnt() { return _lclGlbSrcExaCnt; }
  ...
  vector<int>& ctb2GlbSrcNodeMap() { return _ctb2GlbSrcNodeMap; }
  /*! Return vector of integers describing contributor to global exact source map */
  vector<int>& ctb2GlbSrcExaMap() { return _ctb2GlbSrcExaMap; }
  ...
  vector<int>& usr2GlbSrcNodeMap() { return _usr2GlbSrcNodeMap; }
  /*! Return vector of integers describing user to global exact source map */
  vector<int>& usr2GlbSrcExaMap() { return _usr2GlbSrcExaMap; }
  ...
  int  procLclNum(Vec pos) { int tmp; VecGetLocalSize(pos, &tmp); return tmp/dim(); }
  /*! For a certain processor, return global number of positions from Vec pos */
  int  procGlbNum(Vec pos) { int tmp; VecGetSize(     pos, &tmp); return tmp/dim(); }
  ...
  void procLclRan(Vec pos, int& beg, int& end) { VecGetOwnershipRange(pos, &beg, &end); beg=beg/dim(); end=end/dim(); }
};
