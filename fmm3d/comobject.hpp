...
//! ComObject class for communication purposes.  For sequential code, ComObject does very little.  See comobject_mpi.hpp for parallel code and how it is used */
class ComObject
{
protected:
